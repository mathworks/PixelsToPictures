# Pixels to Pictures<br /><br /> [![Open in MATLAB Online](https://www.mathworks.com/images/responsive/global/open-in-matlab-online.svg)](https://matlab.mathworks.com/open/github/v1?repo=mathworks/PixelsToPictures)

**Curriculum Module**  
_Created with R2024b. Compatible with R2024b and later releases._ 

## Description ##
With Pixels to Pictures, students will use MATLAB&reg;, the programming platform used by scientists and engineers, to edit images, build GIFs, and create filters used in popular apps like Instagram&trade;, Snapchat&trade;, or TikTok&trade;!


This material contains interactive MATLAB [Live Scripts](https://www.mathworks.com/products/matlab/live-editor.html) to assist instructors in teaching computer programming and image manipulation concepts. They can be leveraged as demonstrations, activities, or interactive assignments. 

## What is a Live Script? ##

Within this content, MATLAB [Live Scripts](https://www.mathworks.com/products/matlab/live-editor.html) (".MLX") are employed, which are interactive documents that combine MATLAB code with formatted text, equations, and images in a single environment called the Live Editor. Both “.M” files and “.MLX” files will execute the written code the same, but the [Live Scripts](https://www.mathworks.com/products/matlab/live-editor.html) are meant to be interacted with as an educational or visual tool.
...
_Note: Modules are also available in PDF document format._
...
## Prerequisites ##
There are no prerequisites for these modules, but instructors and students can use [MATLAB Onramp](https://matlabacademy.mathworks.com/details/matlab-onramp/gettingstarted) or [Learn to Code](https://learntocode.mathworks.com/) (for beginner students) as a resource to become familiar with [Live Scripts](https://www.mathworks.com/products/matlab/live-editor.html) and MATLAB syntax.
...
Each module has its own Instructor Guide in the form of a [Live Script](https://www.mathworks.com/products/matlab/live-editor.html) or PDF document. These contain all the background information, course preparation, and lesson plans for the activities to cover with the students. Be sure to read them carefully as they contain the basic information you need to teach each module successfully. 
...
While you use the Instructor Guides to direct the modules, students will be opening [Live Scripts](https://www.mathworks.com/products/matlab/live-editor.html) through the File Explorer or via the command line , as shown below:
